...
public partial class AddFolderWindow : Window
{
    ...
    {
        InitializeComponent();RootBox.ItemsSource=roots;RootBox.SelectedIndex=roots.Count==1?0:-1;OfflineText.Visibility=roots.Count==0?Visibility.Visible:Visibility.Collapsed;
    }
