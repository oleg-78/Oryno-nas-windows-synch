...
{
    private string _status = "Checking Oryno NAS...", _connectionMessage = "Starting connection check.", _connectionTone = "Warning", _indexed = "0", _waiting = "0", _errors = "0", _lastSync = "No successful file sync yet", _queue = "0 changes waiting safely", _errorSummary = "No sync errors", _historical = "No resolved history";
