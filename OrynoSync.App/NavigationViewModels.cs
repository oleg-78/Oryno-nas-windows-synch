...
public sealed class MappingCardViewModel : ViewModelBase
{
    ...
    public Action? Open { get; set; } public Action? Pause { get; set; } public Action? Remove { get; set; } public Action? Rebuild { get; set; } public MappingCardViewModel(SyncMapping mapping) { _mapping = mapping; Apply(mapping); }
